...
export const useUIStore = create(
  persist(
    (set) => ({
      ...
      isHelpOpen: false,
      setIsHelpOpen: (isOpen) => set((state) => ({
        isHelpOpen: typeof isOpen === 'function' ? isOpen(state.isHelpOpen) : Boolean(isOpen),
      })),
    ...
    }),
    {
      ...
      merge: (persisted, state) => ({
        ...state,
        isDockOpen: typeof persisted?.isDockOpen === 'boolean' ? persisted.isDockOpen : true,
      }),
      partialize: (state) => ({
