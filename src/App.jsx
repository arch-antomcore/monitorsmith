...
const MotionBlurTestMode = lazy(() => import('./components/Modes/MotionBlurTestMode'));
const TouchTesterMode = lazy(() => import('./components/Modes/TouchTesterMode'));
const DisplayInfoMode = lazy(() => import('./components/Modes/DisplayInfoMode'));
const RefreshRateMode = lazy(() => import('./components/Modes/RefreshRateMode'));
const ReactionTestMode = lazy(() => import('./components/Modes/ReactionTestMode'));
const UniformityMode = lazy(() => import('./components/Modes/UniformityMode'));
const GradientBandingMode = lazy(() => import('./components/Modes/GradientBandingMode'));
const PixelExerciserMode = lazy(() => import('./components/Modes/PixelExerciserMode'));
const KeyboardTestMode = lazy(() => import('./components/Modes/KeyboardTestMode'));
const MouseTestMode = lazy(() => import('./components/Modes/MouseTestMode'));
const GamepadTestMode = lazy(() => import('./components/Modes/GamepadTestMode'));
const AudioTestMode = lazy(() => import('./components/Modes/AudioTestMode'));
const WebcamTestMode = lazy(() => import('./components/Modes/WebcamTestMode'));
const DisplayCalculatorsMode = lazy(() => import('./components/Modes/DisplayCalculatorsMode'));
const ScreenRulerMode = lazy(() => import('./components/Modes/ScreenRulerMode'));
...
function DisplaySuite() {
  ...
  const [showOnboarding, setShowOnboarding] = useState(() => {
    try { return typeof window !== 'undefined' && !localStorage.getItem('ms_onboarding_done'); }
    catch { return true; }
  });
  ...
  const restoreHomeFocus = useCallback((request) => {
    ...
    const focusTarget =
      origin?.querySelector('button, a[href]') || origin ||
  ...
  const renderActiveMode = () => {
    switch (activeMode) {
      ...
      case MODES.TOUCH_TESTER:
        return (
          <TouchTesterMode
            {...commonModeProps}
          />
        );
      case MODES.DISPLAY_INFO:
        return <DisplayInfoMode {...commonModeProps} />;
      case MODES.REFRESH_RATE:
        return <RefreshRateMode {...commonModeProps} />;
      case MODES.REACTION_TEST:
        return <ReactionTestMode {...commonModeProps} />;
      case MODES.UNIFORMITY:
        return <UniformityMode {...commonModeProps} />;
      case MODES.GRADIENT_BANDING:
        return <GradientBandingMode {...commonModeProps} />;
      case MODES.PIXEL_EXERCISER:
        return <PixelExerciserMode {...commonModeProps} />;
      case MODES.KEYBOARD_TEST:
        return <KeyboardTestMode {...commonModeProps} />;
      case MODES.MOUSE_TEST:
        return <MouseTestMode {...commonModeProps} />;
      case MODES.GAMEPAD_TEST:
        return <GamepadTestMode {...commonModeProps} />;
      case MODES.AUDIO_TEST:
        return <AudioTestMode {...commonModeProps} />;
      case MODES.WEBCAM_TEST:
        return <WebcamTestMode {...commonModeProps} />;
      case MODES.DISPLAY_CALCULATORS:
        return <DisplayCalculatorsMode {...commonModeProps} />;
      case MODES.SCREEN_RULER:
        return <ScreenRulerMode {...commonModeProps} />;
      case MODES.BLACK:
      default:
