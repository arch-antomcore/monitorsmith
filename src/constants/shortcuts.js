...
export const MODE_IDS = Object.freeze({
  ...
  TOUCH_TESTER: 'touch-tester',
  DISPLAY_INFO: 'display-info',
  REFRESH_RATE: 'refresh-rate',
  REACTION_TEST: 'reaction-test',
  UNIFORMITY: 'uniformity',
  GRADIENT_BANDING: 'gradient-banding',
  PIXEL_EXERCISER: 'pixel-exerciser',
  KEYBOARD_TEST: 'keyboard-test',
  MOUSE_TEST: 'mouse-test',
  GAMEPAD_TEST: 'gamepad-test',
  AUDIO_TEST: 'audio-test',
  WEBCAM_TEST: 'webcam-test',
  DISPLAY_CALCULATORS: 'display-calculators',
