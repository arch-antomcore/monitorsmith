  ...
  },
  {
    ...
    seoPages: [
      seoPage('monitor-test',
        ...
        { slug: 'monitor-test', title: 'Online Visual Monitor Test', h1: 'Visual Monitor Test', description: 'Observe gradients, contrast, grayscale and sharpness with browser-rendered visual patterns.' }, '2026-09-23'),
      seoPage('display-calibration',
        ...
        { slug: 'display-calibration', title: 'Visual Display Check Patterns', h1: 'Visual Display Check', description: 'Use reference patterns to observe contrast, tones, sharpness and uniformity without claiming instrument-grade calibration.' }, '2026-09-23'),
    ],
  },
  {
    id: 'white',
    ...
    seoPages: [
      seoPage('webcam-light',
        ...
        { slug: 'webcam-light', title: 'Adjustable Screen Light for Video Calls', h1: 'Screen Light for Video Calls', description: 'Use your monitor as a nearby adjustable light source for video calls and recordings.' }, '2026-09-23'),
    ],
  },
  {
    id: 'color',
  ...
  },
  {
    ...
    seoPages: [
      seoPage('sponsor-loop',
        ...
        { slug: 'sponsor-loop', title: 'Fullscreen Sponsor and Brand Loop', h1: 'Fullscreen Brand Loop', description: 'Present local logos and images in an automatic rotation for events, streams and displays.' }, '2026-09-23'),
    ],
  },
  {
    id: 'ppi-calculator',
    ...
    seoPages: [
      seoPage('ppi-calculator',
        ...
        { slug: 'ppi-monitor-calculator', title: 'Monitor PPI and Pixel Density Calculator', h1: 'Monitor PPI & Pixel Density Calculator', description: 'Calculate PPI, dot pitch in millimetres and the distance corresponding to one arcminute.' }, '2026-09-23'),
    ],
  },
  {
    id: 'motion-blur',
