...
export const TOOLS_REGISTRY = Object.freeze([
  ...
  },
  {
    ...
    badge: 'Mobile',
    description: 'Teste zonas mortas e multi-toque do seu celular, tablet ou monitor touch.',
    heroDesc: 'Desenhe na tela para mapear zonas mortas e verificar o limite de multi-toque simultâneo do seu dispositivo (celular, tablet ou tela touch).',
    when: 'Para diagnosticar falhas no display touch e limites de multi-toque.',
    icon: 'touch',
    tone: 'pixel',
    keyboard: null,
    ...
    seoPages: [
      seoPage('touch-tester',
        { slug: 'teste-de-touchscreen-celular-tablet', title: 'Teste de Touchscreen e Multi-toque (Zonas Mortas)', h1: 'Teste de Touchscreen e Zonas Mortas', description: 'Teste a tela de toque do celular ou tablet. Desenhe em toda a superfície para detectar falhas no digitador, touch fantasma e suporte a múltiplos dedos simultâneos.' },
        { slug: 'touchscreen-multitouch-test', title: 'Touchscreen Dead Zone & Multitouch Test', h1: 'Touchscreen Dead Zone Test', description: 'Test your smartphone or tablet touch digitizer. Draw across the full display to find dead zones, ghost touches, and check max multi-touch points.' }),
    ],
  },
  {
    id: 'display-info',
  ...
  },
  {
    ...
    heroDesc: 'Percorra degraus de cinza de 0% a 100% em tela cheia, com grade opcional de nove zonas, para localizar clouding, vazamento de borda e manchas de retenção.',
    when: 'Para avaliar um painel novo ou documentar defeitos antes de acionar a garantia.',
    icon: 'layers',
    tone: 'clean',
  ...
  },
  {
    ...
    description: 'Rampas suaves para detectar degraus de cor e dithering do driver.',
    heroDesc: 'Rampas lineares em cinza e nos canais primários mostram se o caminho de sinal entrega transições suaves ou degraus visíveis por truncamento de 6 e 8 bits.',
    when: 'Para checar profundidade de cor efetiva e qualidade do dithering.',
    icon: 'gradient',
    tone: 'calibration',
  ...
  },
  {
    ...
    description: 'Ciclo rápido de cores para estimular subpixels presos e retenção leve.',
    heroDesc: 'Alterna cores em alta frequência sobre a área escolhida para estimular subpixels presos e ajudar a dissipar retenção de imagem temporária em OLED.',
    when: 'Para tentar recuperar um pixel preso ou aliviar retenção recente.',
    icon: 'refresh',
    tone: 'pixel',
    keyboard: null,
  ...
  },
  {
    ...
    dockLabel: 'Teclado',
    heroTitle: 'Teste de Teclado e N-Key Rollover',
    badge: 'NKRO',
    description: 'Mapa visual de teclas, histórico de códigos e teclas simultâneas.',
    heroDesc: 'Um mapa ANSI completo acende cada tecla registrada, guarda o histórico de códigos, mede o intervalo entre repetições e conta quantas teclas o controlador aceita ao mesmo tempo.',
    when: 'Para investigar teclas mortas, chattering e a simultaneidade observada pelo navegador.',
    icon: 'keyboard',
    tone: 'focus',
    keyboard: null,
    ...
    seoPages: [
      seoPage('keyboard-test',
        { slug: 'teste-de-teclado-online', title: 'Teste de Teclado Online: Teclas Mortas e N-Key Rollover', h1: 'Teste de Teclado Online', description: 'Verifique teclas mortas, chattering, códigos de scan e o limite de N-key rollover do seu teclado direto no navegador.' },
        { slug: 'keyboard-test', title: 'Online Keyboard Test: Dead Keys and N-Key Rollover', h1: 'Online Keyboard Test', description: 'Check dead keys, chattering, scan codes and the N-key rollover limit of your keyboard right in the browser.' }),
    ],
  },
  {
    id: 'mouse-test',
    ...
    seoPages: [
      seoPage('mouse-test',
        { slug: 'teste-de-mouse-online', title: 'Teste de Mouse Online: Botões, Polling Rate e Clique Duplo', h1: 'Teste de Mouse Online', description: 'Teste botões, roda de rolagem, taxa de polling em Hz e detecte cliques duplos indesejados de switches desgastados.' },
        { slug: 'mouse-test', title: 'Online Mouse Test: Buttons, Polling Rate and Double Click', h1: 'Online Mouse Test', description: 'Test buttons, scroll wheel, polling rate in Hz and detect unintended double clicks from worn switches.' }),
    ],
  },
  {
    id: 'gamepad-test',
    ...
    heroDesc: 'Leia via Gamepad API todos os botões, os eixos dos analógicos com valor numérico, a pressão dos gatilhos e dispare a vibração para confirmar os motores.',
    when: 'Para medir stick drift, zona morta e gatilhos antes de um reparo ou compra.',
    icon: 'gamepad',
    tone: 'pixel',
    keyboard: null,
    ...
    seoPages: [
      seoPage('gamepad-test',
        { slug: 'teste-de-controle-online', title: 'Teste de Controle Online: Stick Drift, Botões e Gatilhos', h1: 'Teste de Controle e Stick Drift', description: 'Teste botões, eixos analógicos, zona morta, stick drift, gatilhos e vibração de qualquer controle no navegador.' },
        { slug: 'gamepad-test', title: 'Online Gamepad Test: Stick Drift, Buttons and Triggers', h1: 'Gamepad and Stick Drift Test', description: 'Test buttons, analog axes, dead zone, stick drift, triggers and rumble for any controller in the browser.' }),
    ],
  },
  {
    id: 'audio-test',
    ...
    heroDesc: 'Toque tons puros em cada canal para conferir a fiação estéreo, faça uma varredura de 20 Hz a 20 kHz e veja o nível do microfone em tempo real com medidor de picos.',
  ...
  },
  {
    ...
    heroDesc: 'Três calculadoras em um painel: banda necessária em Gbps por resolução, taxa e profundidade de cor; distância de visão com campo de visão horizontal; e dimensões físicas por proporção.',
    ...
    seoPages: [
      seoPage('display-calculators',
        { slug: 'calculadora-de-banda-hdmi-displayport', title: 'Calculadora de Banda HDMI/DisplayPort, FOV e Proporção', h1: 'Calculadoras de Banda, FOV e Proporção', description: 'Calcule a banda de vídeo em Gbps por resolução e taxa, a distância ideal por campo de visão e as dimensões físicas por proporção de tela.' },
        { slug: 'hdmi-displayport-bandwidth-calculator', title: 'HDMI/DisplayPort Bandwidth, FOV and Aspect Ratio Calculator', h1: 'Bandwidth, FOV and Aspect Ratio Calculators', description: 'Compute video bandwidth in Gbps per resolution and refresh rate, ideal viewing distance by field of view, and physical size per aspect ratio.' }),
    ],
  },
  {
    id: 'screen-ruler',
...
export const TOOL_I18N = Object.freeze({
  ...
  'ppi-calculator': {
    en: { title: 'PPI & retina calculator', description: 'Pixel density, dot pitch and 20/20 viewing distance.' },
    es: { title: 'Calculadora de PPI y retina', description: 'Densidad de píxeles, dot pitch y distancia 20/20.' },
  },
  'motion-blur': {
  ...
  'touch-tester': {
    en: { title: 'Touchscreen test', description: 'Map dead zones and multi-touch limits on phones and tablets.' },
    es: { title: 'Prueba de pantalla táctil', description: 'Mapea zonas muertas y el límite multitáctil.' },
  },
  'display-info': {
  ...
  'gradient-banding': {
    en: { title: 'Gradient & banding', description: 'Smooth ramps to spot color steps and driver dithering.' },
    es: { title: 'Degradado y banding', description: 'Rampas suaves para ver escalones de color y dithering.' },
  },
  'pixel-exerciser': {
    en: { title: 'Pixel exerciser', description: 'Fast color cycling to stimulate stuck subpixels and retention.' },
    es: { title: 'Ejercitador de píxeles', description: 'Ciclo rápido de colores para píxeles atascados y retención.' },
  },
  'keyboard-test': {
    en: { title: 'Keyboard test', description: 'Visual key map, scan-code history and simultaneous keys.' },
