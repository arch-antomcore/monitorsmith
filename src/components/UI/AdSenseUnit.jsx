...
import { isValidAdSlot, resolveAdSlot } from '../../lib/adConfig';
...
export default function AdSenseUnit({
  ...
  const resolvedSlot = useMemo(() => resolveAdSlot(placement, slot), [placement, slot]);
  const isConfigured = isValidClient(ADSENSE_CLIENT) && isValidAdSlot(resolvedSlot);
