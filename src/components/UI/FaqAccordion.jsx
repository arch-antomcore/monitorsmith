...
export function FaqAccordion({
  ...
  return (
    <div className={cn('w-full py-2', className)}>
      {timestamp ? (
        <p className="mb-6 text-xs font-mono tracking-widest text-white/50 uppercase flex items-center gap-2">
          <span
              ...
              >
                ...
                <span
                  className={cn(
                    ...
                    isOpen && 'border-white/[0.28] bg-white/[0.12] text-white shadow-sm',
                  )}
                  aria-hidden="true"
                >
