        ...
        >
          ...
          >
            ...
            <div style={{ fontSize: '0.84rem', color: 'rgba(255,255,255,0.78)', lineHeight: 1.6, display: 'flex', flexDirection: 'column', gap: '14px' }}>
              ...
              <h3 style={{ margin: '8px 0 4px', fontSize: '0.95rem', color: '#34d399' }}>1. Coleta de Dados e Cookies</h3>
              <p>
              ...
              <h3 style={{ margin: '8px 0 4px', fontSize: '0.95rem', color: '#34d399' }}>2. Anúncios de Terceiros e Google AdSense</h3>
              <p>
              ...
              <h3 style={{ margin: '8px 0 4px', fontSize: '0.95rem', color: '#34d399' }}>3. Opção de Desativação</h3>
              <p>
                Os usuários podem desativar a publicidade personalizada acessando as <a href="https://www.google.com/settings/ads" target="_blank" rel="noopener noreferrer" style={{ color: '#34d399' }}>Configurações de Anúncios do Google</a>.
              </p>

              <h3 style={{ margin: '8px 0 4px', fontSize: '0.95rem', color: '#34d399' }}>4. Contato</h3>
              <p>
