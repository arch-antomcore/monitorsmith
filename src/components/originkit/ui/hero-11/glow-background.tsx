...
export const GlowBackground = () => {
  return (
    <div
      ...
      style={{ filter: "hue-rotate(35deg) saturate(1.2)" }}
      aria-hidden="true"
    >
      <img
  ...
  return (
    ...
    >
      <img
        ...
        width={1440}
        height={840}
        className="absolute inset-0 hidden size-full object-cover object-[center_top] mix-blend-screen brightness-125 saturate-150 desktop-sm:block"
