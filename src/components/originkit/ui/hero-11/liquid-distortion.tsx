...
void main () {
  ...
  vec4 img = sample_image_smooth(img_uv);
  float opacity = get_img_frame_alpha(frame_uv, .002) * img.a;
...
`;
    ...
    function setupEvents() {
      ...
      const onMove = (e: MouseEvent) => {
        ...
        updatePointerPosition(e.clientX - cachedRect.left, e.clientY - cachedRect.top);
      };
      const onTouchMove = (e: TouchEvent) => {
        isHovering = true;
        e.preventDefault();
        const t = e.targetTouches[0];
        updatePointerPosition(t.clientX - cachedRect.left, t.clientY - cachedRect.top);
      };
      const onTouchStart = () => {
        isHovering = true;
        updateCachedRect();
    ...
    function resizeCanvas() {
      ...
      const baseResolution = 512 + ((resolution - 1) * (1024 - 512)) / 9;
