...
const L = {
  pt: {
    ...
    driftOk: 'Abaixo da referência de triagem 0,05; compare no uso real.',
    driftMid: 'Entre as referências 0,05 e 0,08. Solte os analógicos e repita.',
  ...
  en: {
    ...
    driftOk: 'Below the 0.05 triage reference; compare in real use.',
    driftMid: 'Between the 0.05 and 0.08 references. Release the sticks and repeat.',
  ...
  es: {
    ...
    driftOk: 'Por debajo de la referencia orientativa 0,05; compáralo en uso real.',
    driftMid: 'Entre las referencias 0,05 y 0,08. Suelta los sticks y repite.',
