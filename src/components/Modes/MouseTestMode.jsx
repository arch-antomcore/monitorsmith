...
const L = {
  pt: {
    ...
    ok: 'Nenhum intervalo abaixo de 60 ms foi marcado.',
  ...
  en: {
    title: 'Mouse test',
    desc: 'Click the buttons, spin the wheel and move the cursor inside the sampling area. This tool displays those events locally and does not upload them.',
    ...
    ok: 'No interval below 60 ms was flagged.',
  ...
  es: {
    ...
    desc: 'Haz clic en los botones, gira la rueda y mueve el cursor dentro del área de muestreo. Esta herramienta muestra esos eventos localmente y no los sube.',
    ...
    ok: 'No se marcó ningún intervalo inferior a 60 ms.',
