...
const L = {
  pt: {
    ...
    desc: 'Informações de tela e renderizador WebGL expostas pelo navegador, com os limites de cada leitura.',
    ...
    gpu: 'Renderizador WebGL', vendor: 'Fornecedor WebGL', cores: 'Núcleos lógicos', memory: 'Memória estimada',
    ...
    hdrHigh: 'Faixa alta reportada', hdrNotReported: 'Faixa alta não reportada',
  },
  en: {
    title: 'Display fact sheet',
    desc: 'Screen and WebGL renderer information exposed by the browser, with the limits of each reading.',
    ...
    gpu: 'WebGL renderer', vendor: 'WebGL vendor', cores: 'Logical cores', memory: 'Estimated memory',
    ...
    hdrHigh: 'High range reported', hdrNotReported: 'High range not reported',
  },
  es: {
    title: 'Ficha técnica de la pantalla',
    desc: 'Información de pantalla y del renderizador WebGL expuesta por el navegador, con los límites de cada lectura.',
    ...
    gpu: 'Renderizador WebGL', vendor: 'Proveedor WebGL', cores: 'Núcleos lógicos', memory: 'Memoria estimada',
    ...
    copy: 'Copiar ficha', copied: 'Ficha copiada',
    hdrHigh: 'Rango alto reportado', hdrNotReported: 'Rango alto no reportado',
  },
};
...
export default function DisplayInfoMode({ onExit }) {
  ...
  const facts = (() => {
    ...
    return {
      ...
      hdr: dyn ? s.hdrHigh : s.hdrNotReported,
