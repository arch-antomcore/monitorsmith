...
- **A regra:** Tipografia sóbria, cores sólidas e contraste verificado contra o alvo de acessibilidade adotado pelo projeto, no mínimo WCAG 2.2 AA para o MonitorSmith.
...
- [ ] A navegação por teclado, os nomes acessíveis e o contraste foram verificados com testes automatizados e revisão manual.
